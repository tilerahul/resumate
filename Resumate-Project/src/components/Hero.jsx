      ...
      <section className="bg-white dark:bg-gray-900 w-auto m-auto pt-10">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <Link to="/resume" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-primary-primary-blue hover:bg-[rgb(103,176,200)] focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
              Build your Resume
