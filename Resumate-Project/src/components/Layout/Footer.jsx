...
const Footer = () => {
    return (
        <footer className=" mt-5 bg-white dark:bg-gray-900 shadow-md">
            <div className="container px-6 py-8 mx-auto">
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex flex-wrap justify-center mt-6 -mx-4">
                        ...
                        <Link to="/team" className="mx-4 text-sm text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit"> Teams </Link>
                        ...
                        <Link to="/cookie" className="mx-4 text-sm text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit"> Cookies </Link>
                    </div>
                ...
                <div className="flex flex-col items-center sm:flex-row sm:justify-between">
                    <p className="text-sm text-gray-500 dark:text-gray-300">resumate.com © Copyright 2024. All Rights Reserved.</p>
