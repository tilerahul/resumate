...
<div className="mt-10 mx-4 mr-4 grid gap-6 text-center md:grid-cols-3 lg:gap-12">
  ...
  <div className="mb-12 md:mb-0">
    ...
    <h5 className="mb-4 text-xl font-semibold">xyz</h5>
    <p className="mb-4">
      <svg
      ...
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis maiores doloribus officiis pariatur tempora id.
    </p>
